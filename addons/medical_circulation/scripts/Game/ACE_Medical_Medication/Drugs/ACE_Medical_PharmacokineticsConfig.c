...
class ACE_Medical_PharmacokineticsConfig
{
	...
	[Attribute(desc: "Rate constant for the activation of the drug [1/s]", precision: 8, params: "0 inf")]
	float m_fActivationRateConstant;
	
	[Attribute(desc: "Rate constant for the deactivation of the drug [1/s]", precision: 8, params: "0 inf")]
