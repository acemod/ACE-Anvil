class ACE_MedicalDefibrillation_QueryNearestDefib : ACE_QueryNearestEntity
{
	//------------------------------------------------------------------------------------------------
	//! Pass search radius in ctor
	void ACE_MedicalDefibrillation_QueryNearestDefib(float searchDistance = 50)
	{
	...
	override IEntity GetEntity(vector pos)
	{
		...
		ACE_MedicalDefibrillation_DefibrillatorComponent defibrillatorComponent = ACE_MedicalDefibrillation_DefibrillatorComponent.Cast(m_pNearestEntity.FindComponent(ACE_MedicalDefibrillation_DefibrillatorComponent));
		if (!defibrillatorComponent)
			return null;
