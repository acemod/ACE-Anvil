...
class ACE_Medical_BaseSystem2 : GameSystem
{
	...
	//------------------------------------------------------------------------------------------------
	static ACE_Medical_BaseSystem2 GetInstance(typename type)
	{
		ChimeraWorld world = GetGame().GetWorld();
		return ACE_Medical_BaseSystem2.Cast(world.FindSystem(type));
	}
