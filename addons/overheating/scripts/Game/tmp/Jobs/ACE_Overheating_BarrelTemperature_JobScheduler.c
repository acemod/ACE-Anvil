...
[BaseContainerProps()]
class ACE_Overheating_BarrelTemperature_JobScheduler : ACE_IFrameJob
{
	...
	void OnInit(ACE_Overheating_BarrelTemperatureJob templateJob)
	{
	...
	protected void UpdateQueueStep(float currentTime)
	{
		...
		{
			ACE_Overheating_BarrelTemperatureJob job = m_aJobs[i];
	...
	void Register(ACE_Overheating_MuzzleJamComponent object)
	{
		...
		ACE_Overheating_BarrelTemperatureJob job = CreateJob();
	...
	{
		ACE_Overheating_BarrelTemperatureJob job = m_aJobs[machineIdx];
		m_aJobs.Remove(machineIdx);
		job.OnStop();
	}
	
	//------------------------------------------------------------------------------------------------
	protected ACE_Overheating_BarrelTemperatureJob CreateJob()
	{
		ACE_Overheating_BarrelTemperatureJob instance = new ACE_Overheating_BarrelTemperatureJob();
