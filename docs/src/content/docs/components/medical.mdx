...
import coreTreatmentPlantUML1 from '../../plantumls/medical/core-treatment-1.puml';
import coreTreatmentPlantUML2 from '../../plantumls/medical/core-treatment-2.puml';
import circulationTreatmentPlantUML1 from '../../plantumls/medical/circulation-treatment-1.puml';
import breathingTreatmentPlantUML1 from '../../plantumls/medical/breathing-treatment-1.puml';
...
<div class="grid grid-cols-3">
    <PlantUML src={coreTreatmentPlantUML1} />
    <PlantUML src={coreTreatmentPlantUML2} />
</div>
...
<Image src="/images/medical/organic-hit-zones.png" alt="organic-hit-zones.png" width="200px" height="200px" align="right" />
...
<PlantUML src={circulationTreatmentPlantUML1} />
...
<PlantUML src={breathingTreatmentPlantUML1} />
