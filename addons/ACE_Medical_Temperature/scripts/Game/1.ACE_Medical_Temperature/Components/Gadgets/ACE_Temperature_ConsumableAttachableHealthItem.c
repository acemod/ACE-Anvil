//------------------------------------------------------------------------------------------------
[BaseContainerProps()]
//Direct copy of ACE_Medical_ConsumableAttachableHealthItem from breathing
class ACE_Temperature_ConsumableAttachableHealthItem : SCR_ConsumableEffectHealthItems
{
	...
	void ACE_Temperature_ConsumableAttachableHealthItem()
	{
