...
//! ACE_TemplateFrameJobScheduler<IEntity, ACE_MedicalDefibrillation_DefibrillatorContext, ACE_MedicalDefibrillation_DefibStateMachine>
//! as workaround for:
//! - https://feedback.bistudio.com/T193122
//! - https://feedback.bistudio.com/
[BaseContainerProps()]
class ACE_MedicalDefibrillation_DefibStates_JobScheduler : ACE_IFrameJob
{
	...
	protected ref ACE_MedicalDefibrillation_DefibStateMachine m_pTemplateJob;
	protected ref array<ref ACE_MedicalDefibrillation_DefibStateMachine> m_aJobs = {};
	...
	void OnInit(ACE_MedicalDefibrillation_DefibStateMachine templateJob)
	{
	...
	//------------------------------------------------------------------------------------------------
	array<ref ACE_MedicalDefibrillation_DefibStateMachine> GetJobs()
	{
		return m_aJobs;
	}
	...
	protected void UpdateQueueStep(float currentTime)
	{
		...
		{
			ACE_MedicalDefibrillation_DefibStateMachine job = m_aJobs[i];
	...
	protected void UpdateObjectsStep(float currentTime)
	{
		...
		{
			ACE_MedicalDefibrillation_DefibStateMachine job = m_aJobs[m_iCurrentJobIdx];
			ACE_MedicalDefibrillation_DefibrillatorContext context = job.GetContext();
	...
	void Register(IEntity object)
	{
		...
		ACE_MedicalDefibrillation_DefibrillatorContext context = new ACE_MedicalDefibrillation_DefibrillatorContext(object);
		if (!context.IsValid())
			return;
		
		ACE_MedicalDefibrillation_DefibStateMachine job = CreateJob();
	...
	{
		foreach (int i, ACE_MedicalDefibrillation_DefibStateMachine job : m_aJobs)
		{
	...
	{
		ACE_MedicalDefibrillation_DefibStateMachine job = m_aJobs[machineIdx];
		m_aJobs.Remove(machineIdx);
		job.OnStop();
	}
	
	//------------------------------------------------------------------------------------------------
	protected ACE_MedicalDefibrillation_DefibStateMachine CreateJob()
	{
		ACE_MedicalDefibrillation_DefibStateMachine instance = new ACE_MedicalDefibrillation_DefibStateMachine();
