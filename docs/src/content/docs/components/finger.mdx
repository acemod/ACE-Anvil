...
| `m_fPointingRangeM`                   | Type: `float`**<br />Range: -1 to ∞<br />Default: `10.0` | Range of the pointing in meters. Only players in range will see it. Anyone can see it if negative. |
