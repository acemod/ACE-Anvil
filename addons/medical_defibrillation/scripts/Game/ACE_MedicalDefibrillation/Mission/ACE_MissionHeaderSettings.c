...
{
	[Attribute()]
	protected ref ACE_MedicalDefibrillation_Defibrillation_Settings m_ACE_MedicalDefibrillation;
	...
	override void ApplyToSettingsConfig(notnull ACE_SettingsConfig config)
	{
		...
		if (m_ACE_MedicalDefibrillation)
			config.SetModSettings(m_ACE_MedicalDefibrillation);
	}
}
