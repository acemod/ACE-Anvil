...
| `m_bSecondChanceForAIEnabled`         | Type: `bool`*<br />Default: `true` | Whether AI can have second chance |
...
The changes are also applied to AI, but cardiac arrest can be turned off for them, such that they directly die when entering it (see `m_bCardiacArrestForAIEnabled` in [Settings](#settings-2)).
...
| `m_bCardiacArrestForAIEnabled`        | Type: `bool`*<br />Default: `true` | AI will die instead of entering cardiac arrest if false |
