...
| `m_fMinConvectiveHeatTransferCoefficient` | Type: `float`**<br />Range: 0 to ∞<br />Default: `22.5` | Convective heat transfer coefficient for cooling of barrel in still air [W / (m^2 * K)]. |
...
"missionHeader": {
    "m_ACE_Settings": {
        "m_ACE_Overheating_Settings": {
            ...
            "m_fMinConvectiveHeatTransferCoefficient": 22.5,
