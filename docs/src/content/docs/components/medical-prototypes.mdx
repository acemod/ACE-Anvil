...
ACE Medical Prototypes builds on top of ACE Medical and serves as a testing bed for more advanced features to be added to ACE Medical in future. Current prototypes:
