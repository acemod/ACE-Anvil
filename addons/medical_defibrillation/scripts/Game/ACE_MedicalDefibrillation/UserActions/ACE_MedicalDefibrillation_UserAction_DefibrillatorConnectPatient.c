class ACE_MedicalDefibrillation_UserActions_ConnectPatient : ScriptedUserAction
{
	...
	override bool CanBeShownScript(IEntity user)
	{
		...
		ACE_MedicalDefibrillation_QueryNearestDefib query = new ACE_MedicalDefibrillation_QueryNearestDefib(3);
		...
		ACE_MedicalDefibrillation_DefibrillatorComponent defibComponent = ACE_MedicalDefibrillation_DefibrillatorComponent.Cast(m_pNearestDefib.FindComponent(ACE_MedicalDefibrillation_DefibrillatorComponent));
		if (!defibComponent)
			return false;
