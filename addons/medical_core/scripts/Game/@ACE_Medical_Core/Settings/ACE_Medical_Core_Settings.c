...
class ACE_Medical_Core_Settings : ACE_ModSettings
{
	...
	[Attribute(defvalue: "1.0", desc: "Resilience damage scale. All incoming damage to the resilience hitzone will be multiplied by this factor. Lower values make characters less likely to fall unconscious.", params: "0 inf")]
