...
| Metoprolol injector | <ul><li>Decreases HR</li></ul> | 25 s | 1 min 9 s | 2.8 | > 3 |
...
| `m_fCPRSuccessChanceMin` | `float` | `0` | Chance for reviving while performing CPR at class IV hemorrhage |
...
| Field | Type | Default | Description |
| --- | --- | --- | --- |
| `m_fHeartRateLowBPM` | `float` | `40` | A heart rate below this will trigger a transition to this state [BPM] |
| `m_fHeartRateHighBPM` | `float` | `220` | A heart rate above this will trigger a transition to this state [BPM] |
...
| Field | Type | Default | Description |
| --- | --- | --- | --- |
| `m_fHeartRateLowBPM` | `float` | `30` | A heart rate below this will trigger a transition to this state [BPM] |
| `m_fHeartRateHighBPM` | `float` | `220` | A heart rate above this will trigger a transition to this state [BPM] |
...
| Field | Type | Default | Description |
| --- | --- | --- | --- |
| `m_fHeartRateLowBPM` | `float` | `20` | A heart rate below this will trigger a transition to this state [BPM] |
| `m_fHeartRateHighBPM` | `float` | `220` | A heart rate above this will trigger a transition to this state [BPM] |
| `m_fMeanArterialPressureLowKPA` | `float` | `5.21` | A mean arterial pressure below this will trigger a transition to this state [kPa] |
| `m_fMeanArterialPressureHighKPA` | `float` | `29.5` | A mean arterial pressure above this will trigger a transition to this state [kPa] |
...
| `m_fEffectStartDelayS` | `float` | `10` | Delay in seconds before the effect starts [s] |
        ...
        "m_ACE_Medical_Settings": {
            ...
            "m_CardiovascularSystem": {
                ...
                "m_CardiacArrestDamageEffect": {
                    ...
                    "m_fEffectStartDelayS": 10
                },
                "m_bCardiacArrestForAIEnabled": 0,
                "m_fCPRSuccessCheckTimeoutS": 22,
                "m_fCPRSuccessChanceMin": 0,
