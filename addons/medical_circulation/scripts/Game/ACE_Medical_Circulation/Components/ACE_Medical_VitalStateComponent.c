//------------------------------------------------------------------------------------------------
class ACE_Medical_VitalStateComponentClass : ACE_BaseComponentClass
{
}
...
class ACE_Medical_VitalStateComponent : ACE_BaseComponent
{
	[RplProp()]
	protected ACE_Medical_EVitalStateID m_eVitalState = ACE_Medical_EVitalStateID.STABLE;
	[RplProp()]
	...
	//------------------------------------------------------------------------------------------------
	void SetVitalState(ACE_Medical_EVitalStateID newState)
	{
	...
	//------------------------------------------------------------------------------------------------
	ACE_Medical_EVitalStateID GetVitalState()
	{
	...
	{
		return m_eVitalState == ACE_Medical_EVitalStateID.CARDIAC_ARREST;
	}
