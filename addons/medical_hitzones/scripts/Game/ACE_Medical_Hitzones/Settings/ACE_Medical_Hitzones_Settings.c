//------------------------------------------------------------------------------------------------
[BaseContainerProps()]
class ACE_Medical_Hitzones_Settings : ACE_ModSettings
{
	...
	[Attribute(defvalue: "true", desc: "Whether neck or femoral bleeding instantly cause unconsciousness.")]
	bool m_bInstantUnconOnMassiveBleeding;
}
