...
class ACE_Captives_SurrenderHelperCompartment : ACE_AnimationHelperCompartment
{
	...
	override void Init(SCR_ChimeraCharacter performer)
	{
		...
		SCR_CharacterFactionAffiliationComponent factionAffiliation =
			SCR_CharacterFactionAffiliationComponent.Cast(performer.FindComponent(SCR_CharacterFactionAffiliationComponent));
	...
	override void OnCompartmentLeft()
	{
		...
		SCR_CharacterFactionAffiliationComponent factionAffiliation =
			SCR_CharacterFactionAffiliationComponent.Cast(m_pPerformer.FindComponent(SCR_CharacterFactionAffiliationComponent));
