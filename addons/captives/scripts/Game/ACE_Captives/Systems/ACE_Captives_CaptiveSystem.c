...
{
	protected ref map<SCR_ChimeraCharacter, ref ACE_Captives_CaptiveSystemCharacterWrapper> m_aCaptives =
		new map<SCR_ChimeraCharacter, ref ACE_Captives_CaptiveSystemCharacterWrapper>();
	...
	override static void InitInfo(WorldSystemInfo outInfo)
	{
		...
		outInfo.SetAbstract(false).SetUnique(true).SetLocation(WorldSystemLocation.Server).AddPoint(WorldSystemPoint.BeforeEntitiesCreated);
	}
	...
	void Register(notnull SCR_ChimeraCharacter char)
	{
		...
		SCR_CharacterFactionAffiliationComponent factionAffiliation =
			SCR_CharacterFactionAffiliationComponent.Cast(char.FindComponent(SCR_CharacterFactionAffiliationComponent));
