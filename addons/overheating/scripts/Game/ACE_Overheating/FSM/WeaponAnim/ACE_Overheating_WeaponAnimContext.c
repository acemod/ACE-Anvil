...
class ACE_Overheating_WeaponAnimContext : Managed
{
	...
	ACE_Overheating_MuzzleJamComponent m_pJamComponent;
	...
	//------------------------------------------------------------------------------------------------
	void ACE_Overheating_WeaponAnimContext(ChimeraCharacter char, BaseWeaponComponent weapon, ACE_Overheating_MuzzleJamComponent jamComponent)
	{
