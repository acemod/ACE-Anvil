...
**ACE Anvil is available on the <a href="https://reforger.armaplatform.com/workshop?search=acemod" target="_blank">Arma Reforger Workshop</a> as well as <a href={config.ace.githubUrl} target="_blank">our GitHub</a>.**
