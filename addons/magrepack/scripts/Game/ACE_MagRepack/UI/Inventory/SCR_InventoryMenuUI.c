...
modded class SCR_InventoryMenuUI : ChimeraMenuBase
{
	...
	//------------------------------------------------------------------------------------------------
	//! Checks to ensure we have two magazines that should be repacked, and passes the necessary bits to ACE_MagRepack_RpcAsk_Repack()-function in
	...
	bool ACE_MagRepack_Repack()
	{
		...
		InventoryItemComponent fromInventoryItemComponent, toInventoryItemComponent IEntity fromEntity,
			toEntity
