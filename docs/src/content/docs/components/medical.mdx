...
| --- | --- | --- | --- |
| `m_fHeartRateLowBPM` | `float`**<br />Range: 0 to ∞<br />Default: `40.0` | A heart rate below this will trigger a transition to this state [BPM] |
| `m_fHeartRateHighBPM` | `float`**<br />Range: 0 to ∞<br />Default: `220.0` | A heart rate above this will trigger a transition to this state [BPM] |
| `m_fMeanArterialPressureLowKPA` | `float`**<br />Range: 0 to ∞<br />Default: `7.11` | A mean arterial pressure below this will trigger a transition to this state [kPa] |
| `m_fMeanArterialPressureHighKPA` | `float`**<br />Range: 0 to ∞<br />Default: `29.5` | A mean arterial pressure above this will trigger a transition to this state [kPa] |
| `m_fMaxHeartForMeanArterialPressureLowBPM` | `float`**<br />Range: 0 to ∞<br />Default: `80.0` | Maximum heart rate for trigger due to low mean arterial pressure [bpm] |
| `m_eBloodState` | `int`****<br />Range: 0 to ∞<br />Default: `CLASS_2_HEMORRHAGE` | Blood volume at this level will trigger a transition to this state |
...
| Field | Type | Default | Description |
| --- | --- | --- | --- |
| `m_fHeartRateLowBPM` | `float`**<br />Range: 0 to ∞<br />Default: `30.0` | A heart rate below this will trigger a transition to this state [BPM] |
| `m_fHeartRateHighBPM` | `float`**<br />Range: 0 to ∞<br />Default: `220.0` | A heart rate above this will trigger a transition to this state [BPM] |
| `m_fMeanArterialPressureLowKPA` | `float`**<br />Range: 0 to ∞<br />Default: `5.21` | A mean arterial pressure below this will trigger a transition to this state [kPa] |
| `m_fMeanArterialPressureHighKPA` | `float`**<br />Range: 0 to ∞<br />Default: `29.5` | A mean arterial pressure above this will trigger a transition to this state [kPa] |
| `m_fMaxHeartForMeanArterialPressureLowBPM` | `float`**<br />Range: 0 to ∞<br />Default: `40.0` | Maximum heart rate for trigger due to low mean arterial pressure [bpm] |
| `m_eBloodState` | `int`****<br />Range: 0 to ∞<br />Default: `CLASS_3_HEMORRHAGE` | Blood volume at this level will trigger a transition to this state |

`m_CardiacArrestThresholds`

| Field | Type | Default | Description |
| --- | --- | --- | --- |
| `m_fHeartRateLowBPM` | `float`**<br />Range: 0 to ∞<br />Default: `20.0` | A heart rate below this will trigger a transition to this state [BPM] |
| `m_fHeartRateHighBPM` | `float`**<br />Range: 0 to ∞<br />Default: `220.0` | A heart rate above this will trigger a transition to this state [BPM] |
| `m_fMeanArterialPressureLowKPA` | `float`**<br />Range: 0 to ∞<br />Default: `5.21` | A mean arterial pressure below this will trigger a transition to this state [kPa] |
| `m_fMeanArterialPressureHighKPA` | `float`**<br />Range: 0 to ∞<br />Default: `29.5` | A mean arterial pressure above this will trigger a transition to this state [kPa] |
| `m_fMaxHeartForMeanArterialPressureLowBPM` | `float`**<br />Range: 0 to ∞<br />Default: `30.0` | Maximum heart rate for trigger due to low mean arterial pressure [bpm] |
| `m_eBloodState` | `int`****<br />Range: 0 to ∞<br />Default: `CLASS_4_HEMORRHAGE` | Blood volume at this level will trigger a transition to this state |

#### `m_CardiacArrestDamageEffect`

| Field | Type | Default | Description |
| --- | --- | --- | --- |
| `m_fBrainDamageRate` | `float`**<br />Range: 0 to ∞<br />Default: `0.333` | Damage the brain takes per second |
| `m_fEffectStartDelayS` | `float`**<br />Range: 0 to ∞<br />Default: `10.0` | Delay in seconds before the effect starts [s] |
<br />
