...
modded class SCR_ParamEnumArray : ParamEnumArray
{
	...
	{
		IEntityComponentSource componentSource = SCR_BaseContainerTools.FindComponentSource(
			Resource.Load("{37578B1666981FCE}Prefabs/Characters/Core/Character_Base.et"), SCR_DamageManagerComponent);
		if (!componentSource)
			return null;
